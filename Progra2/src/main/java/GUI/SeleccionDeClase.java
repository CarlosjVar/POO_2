...
public class SeleccionDeClase extends javax.swing.JDialog {
    ...
    public void fillJList ( ArrayList <Class> classArray){
        ...
        for (int i = 0; i < classArray.size();i++){
            Class classTemp = classArray.get(i);
            nombres[i] = classTemp.getName();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionDeClase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SeleccionDeClase().setVisible(true);
        });
    }
